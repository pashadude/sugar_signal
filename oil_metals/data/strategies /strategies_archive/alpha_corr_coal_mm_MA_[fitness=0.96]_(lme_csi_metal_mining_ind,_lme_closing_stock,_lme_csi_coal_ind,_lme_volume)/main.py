config = AlphaConfig()
def alpha_corr_coal_mm_MA(s: Streams) -> pd.DataFrame:
    """
    Hypothesis:
    - Long: postivive correlation (lme_csi_metal_mining_ind and lme_csi_coal_ind) * lme_closing_stock <= SMA (3-day).
    - Short: negative correlation (lme_csi_metal_mining_ind and lme_csi_coal_ind) * lme_closing_stock > SMA (3-day).
    """
    ...
    corr = correlation(series1, series2, window=10)
