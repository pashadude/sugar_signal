config = AlphaConfig()
def alpha_corr_stockinout_2MA_2(s: Streams) -> pd.DataFrame:
    """
    Hypothesis:
    - Long: postivive correlation (lme_stock_in and lme_stock_out) * lme_closing_stock <= SMA (5-day) and <= SMA (6-day).
    - Short: negative correlation (lme_stock_in and lme_stock_out) * lme_closing_stock > SMA (5-day) and > SMA (6-day).
    """
