config = AlphaConfig()
def alpha_csi_nonfer_fut_2sma(s: Streams) -> pd.DataFrame:
    """
    Hypothesis:
    - Long: lme_csi_non_fer_fut_ind > SMA (4-day) AND lme_csi_non_fer_fut_ind > SMA (19-day).
    - Short: lme_csi_non_fer_fut_ind <= SMA (4-day) AND lme_csi_non_fer_fut_ind <= SMA (19-day).
    """

    ver1=s.lme_csi_non_fer_fut_ind
