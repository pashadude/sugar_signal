config = AlphaConfig()
def alpha_ftse_bric_csi_nonfer_fut_2sma(s: Streams) -> pd.DataFrame:
    """
    Hypothesis:
    - Long: lme_ftse_bric_50_ind > SMA (4-day) AND lme_csi_non_fer_fut_ind > SMA (18-day).
    - Short: lme_ftse_bric_50_ind <= SMA (4-day) AND lme_csi_non_fer_fut_ind <= SMA (18-day).
    """

    ver1=s.lme_ftse_bric_50_ind
    ver2=s.lme_csi_non_fer_fut_ind
    sma1 = ts_mean(ver1, window=4)
    sma2 = ts_mean(ver2, window=18)
